...
describe("Game class", function() {
    ...
    describe("Methods on the Game Constructor Function's `.prototype`", function() {
        ...
        describe("checkGuess function", function() {
            it('returns an object with title and/or subtitle properties', function() {
            ...
            it('returns "You Win!" if playersGuess equals winningNumber', function() {
                ...
                expect(game.playersGuessSubmission(42)).toEqual({title: 'You Win!', subtitle: 'Press the Reset button to play again!'});
            });
            it('returns "You have already guessed that number." if playersGuess is in pastGuesses', function() {
                game.winningNumber = 42;
                game.playersGuessSubmission(36);
                expect(game.playersGuessSubmission(36)).toEqual({title: 'You have already guessed that number.', subtitle: 'Guess higher.'});
            })
            it('returns "You have already guessed that number." if playersGuess is in pastGuesses', function() {
                game.winningNumber = 12;
                game.playersGuessSubmission(36);
                expect(game.playersGuessSubmission(36)).toEqual({title: 'You have already guessed that number.', subtitle: 'Guess lower.'});
            })
            ...
            it('returns "You Lose" if this is the players 5th guess', function() {
                ...
                expect(game.playersGuessSubmission(5)).toEqual({title: 'You Lose.', subtitle: 'Press the Reset button to play again!'});
            });
            it('returns "You\'re burning up!" if the difference between playersGuess and winningGuess is less than 10', function() {
                game.winningNumber = 42;
                expect(game.playersGuessSubmission(45)).toEqual({title: 'You\'re burning up!', subtitle: 'Guess lower.'});
            });
            it('returns "You\'re burning up!" if the difference between playersGuess and winningGuess is less than 10', function() {
                game.winningNumber = 42;
                expect(game.playersGuessSubmission(41)).toEqual({title: 'You\'re burning up!', subtitle: 'Guess higher.'});
            });
            it('returns "You\'re lukewarm." if the difference between playersGuess and winningGuess is less than 25', function() {
                game.winningNumber = 42;
                expect(game.playersGuessSubmission(62)).toEqual({title: 'You\'re lukewarm.', subtitle: 'Guess lower.'});
            });
            it('returns "You\'re lukewarm." if the difference between playersGuess and winningGuess is less than 25', function() {
                game.winningNumber = 42;
                expect(game.playersGuessSubmission(30)).toEqual({title: 'You\'re lukewarm.', subtitle: 'Guess higher.'});
            });
            it('returns "You\'re a bit chilly." if the difference between playersGuess and winningGuess is less than 50', function() {
                game.winningNumber = 42;
                expect(game.playersGuessSubmission(72)).toEqual({title: 'You\'re a bit chilly.', subtitle: 'Guess lower.'});
            });
            it('returns "You\'re a bit chilly." if the difference between playersGuess and winningGuess is less than 50', function() {
                game.winningNumber = 100;
                expect(game.playersGuessSubmission(65)).toEqual({title: 'You\'re a bit chilly.', subtitle: 'Guess higher.'});
            });
            it('returns "You\'re ice cold!" if the difference between playersGuess and winningGuess is less than 100', function() {
                game.winningNumber = 42;
                expect(game.playersGuessSubmission(92)).toEqual({title: 'You\'re ice cold!', subtitle: 'Guess lower.'});
            });
            it('returns "You\'re ice cold!" if the difference between playersGuess and winningGuess is less than 100', function() {
                game.winningNumber = 92;
                expect(game.playersGuessSubmission(42)).toEqual({title: 'You\'re ice cold!', subtitle: 'Guess higher.'});
            });
            it('gives an error message if the number is invalid (less than 1, greater than 100, or not a number)', function() {
                expect(game.playersGuessSubmission(0)).toEqual({title: "That is an invalid guess.", subtitle: 'Please submit a positive integer between 1 and 100.'});
                expect(game.playersGuessSubmission(-1)).toEqual({title: "That is an invalid guess.", subtitle: 'Please submit a positive integer between 1 and 100.'});
                expect(game.playersGuessSubmission(101)).toEqual({title: "That is an invalid guess.", subtitle: 'Please submit a positive integer between 1 and 100.'});
                expect(game.playersGuessSubmission("not a number")).toEqual({title: "That is an invalid guess.", subtitle: 'Please submit a positive integer between 1 and 100.'});
            })
